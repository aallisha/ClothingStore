# Generated by Django 3.1.4 on 2021-04-07 07:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('vendor', '0002_auto_20210404_1303'),
        ('product', '0003_auto_20210404_1528'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendors', models.ManyToManyField(related_name='order', to='vendor.Vendor')),
            ],
            options={
                'ordering': ['-created_at'],
            },
